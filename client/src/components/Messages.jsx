          ...
          return (
            ...
            >
              {!isSender && (
                <img
                  src={
                    msg.sender?.profileImg?.url || "/default-avatar.png"
                  }
              ...
              >
                {isGroupChat && !isSender && (
                  <p className="text-xs font-semibold text-[#206059]">
              ...
              {isSender && (
                <img
                  src={
                    user?.profileImg?.url || "/default-avatar.png"
                  }
                  className="w-10 h-10 rounded-full"
                  alt=""
                />
