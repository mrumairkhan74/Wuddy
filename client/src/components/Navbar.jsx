        ...
        <div className='m-2 font-[Poppins] shadow-md rounded-md'>
            <div className='bg-[#206059] p-4 text-[#EBF2FD] flex items-center justify-between rounded-md mt-2'>
                ...
                <div className="flex items-center gap-2">
                    <Link to={'/notes'}><BiTask className='md:hidden h-10 w-10' title='Notes' /></Link>
                    <LuMessageCircleMore
            ...
            {activeMenu === "profile" && (
                <div className="hidden absolute md:flex-col md:flex right-2 top-20 rounded-md mt-2 bg-[#206059] w-[300px]">
            ...
            {activeMenu === "notify" && (
                <div className="notifications hidden absolute md:flex-col md:flex right-16 top-20 mt-2 rounded-md p-5 bg-[#206059] w-[300px] max-h-[400px] overflow-y-auto">
